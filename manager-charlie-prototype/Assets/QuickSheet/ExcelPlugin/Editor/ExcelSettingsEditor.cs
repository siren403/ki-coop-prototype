    ...
    public class ExcelSettingsEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (setting.CheckPath())
            {
                ...
                setting.RuntimePath = GUILayout.TextField(setting.RuntimePath, GUILayout.Width(300));
                if (GUILayout.Button("...", GUILayout.Width(30)))
                {
                    setting.RuntimePath = EditorUtility.OpenFolderPanel(null, Application.dataPath, null);
                }
                GUILayout.EndHorizontal();

                GUILayout.BeginHorizontal();
                GUILayout.Label("Editor Path: ", GUILayout.Width(100));
                setting.EditorPath = GUILayout.TextField(setting.EditorPath,GUILayout.Width(300));
                if (GUILayout.Button("...",GUILayout.Width(30)))
                {
                    setting.EditorPath = EditorUtility.OpenFolderPanel(null, Application.dataPath, null);
                }
                GUILayout.EndHorizontal();
            }
            else
